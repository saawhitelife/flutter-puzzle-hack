...
/// {@template blue_walkie_theme}
/// The blue walkie puzzle theme.
/// {@endtemplate}
class BlueWalkieTheme extends WalkieTheme {
  /// {@macro blue_walkie_theme}
  const BlueWalkieTheme() : super();

  @override
  String semanticsLabel(BuildContext context) =>
      context.l10n.walkieBlueDashLabelText;
