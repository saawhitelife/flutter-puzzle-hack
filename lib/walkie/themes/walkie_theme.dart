...
/// {@template walkie_theme}
/// The walkie puzzle theme.
/// {@endtemplate}
abstract class WalkieTheme extends PuzzleTheme {
  /// {@macro walkie_theme}
  const WalkieTheme() : super();

  @override
  String get name => 'Aquarium';
  ...
  @override
  PuzzleLayoutDelegate get layoutDelegate => const WalkiePuzzleLayoutDelegate();
  ...
  ///
  /// This asset is shown in the Walkie theme picker.
  String get themeAsset;

  /// The path to the success image asset of this theme.
  ///
  /// This asset is shown in the success state of the Walkie puzzle.
