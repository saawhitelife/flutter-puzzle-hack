...
/// {@template yellow_walkie_theme}
/// The yellow walkie puzzle theme.
/// {@endtemplate}
class YellowWalkieTheme extends WalkieTheme {
  /// {@macro yellow_walkie_theme}
  const YellowWalkieTheme() : super();

  @override
  String semanticsLabel(BuildContext context) =>
      context.l10n.walkieYellowDashLabelText;
