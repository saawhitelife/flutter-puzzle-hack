...
/// {@template walkie_share_dialog}
/// Displays a Walkie share dialog with a score of the completed puzzle
/// and an option to share the score using Twitter or Facebook.
/// {@endtemplate}
class WalkieShareDialog extends StatefulWidget {
  /// {@macro walkie_share_dialog}
  const WalkieShareDialog({
    Key? key,
  ...
  @override
  State<WalkieShareDialog> createState() => _WalkieShareDialogState();
}

class _WalkieShareDialogState extends State<WalkieShareDialog>
  ...
  Widget build(BuildContext context) {
    return AudioControlListener(
      key: const Key('walkie_share_dialog_success_audio_player'),
      audioPlayer: _successAudioPlayer,
      child: AudioControlListener(
        key: const Key('walkie_share_dialog_click_audio_player'),
        ...
        child: ResponsiveLayoutBuilder(
          ...
          child: (currentSize) {
            ...
            return Stack(
              key: const Key('walkie_share_dialog'),
              children: [
                  ...
                  child: LayoutBuilder(
                    builder: (context, constraints) {
                      return SizedBox(
                        ...
                        child: Padding(
                          padding: padding,
                          child: WalkieShareDialogAnimatedBuilder(
                ...
                Positioned(
                  ...
                  child: IconButton(
                    key: const Key('walkie_share_dialog_close_button'),
