...
/// The animation builder of [WalkieShareDialog].
class WalkieShareDialogAnimatedBuilder extends StatelessWidget {
  const WalkieShareDialogAnimatedBuilder({
    Key? key,
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return builder(
          context,
          child,
          WalkieShareDialogEnterAnimation(animation as AnimationController),
        );
      },
      child: child,
    );
...
typedef MyTransitionBuilder = Widget Function(
  ...
  Widget? child,
  WalkieShareDialogEnterAnimation animation,
);

class WalkieShareDialogEnterAnimation {
  WalkieShareDialogEnterAnimation(this.controller)
