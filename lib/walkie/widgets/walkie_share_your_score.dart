...
/// {@template walkie_share_your_score}
/// Displays buttons to share a score of the completed puzzle.
/// {@endtemplate}
class WalkieShareYourScore extends StatelessWidget {
  /// {@macro walkie_share_your_score}
  const WalkieShareYourScore({
    Key? key,
    required this.animation,
  }) : super(key: key);

  /// The entry animation of this widget.
  final WalkieShareDialogEnterAnimation animation;
  ...
  Widget build(BuildContext context) {
    ...
    return ResponsiveLayoutBuilder(
      ...
      child: (currentSize) {
        ...
        return Column(
          key: const Key('walkie_share_your_score'),
            ...
            SlideTransition(
              ...
              child: Opacity(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      l10n.walkieSuccessShareYourScoreTitle,
                      key: const Key('walkie_share_your_score_title'),
                      textAlign: textAlign,
                    ...
                    SizedBox(
                      width: messageWidth,
                      child: Text(
                        l10n.walkieSuccessShareYourScoreMessage,
                        key: const Key('walkie_share_your_score_message'),
                        textAlign: textAlign,
