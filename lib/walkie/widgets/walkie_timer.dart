...
/// {@template walkie_timer}
/// Displays how many seconds elapsed since starting the puzzle.
/// {@endtemplate}
class WalkieTimer extends StatelessWidget {
  /// {@macro walkie_timer}
  const WalkieTimer({
    Key? key,
    this.textStyle,
        ...
        return Row(
          ...
          children: [
            ...
            Image.asset(
              ...
              key: const Key('walkie_timer_icon'),
  ...
  String _getDurationLabel(Duration duration, BuildContext context) {
    return context.l10n.walkiePuzzleDurationLabelText(
