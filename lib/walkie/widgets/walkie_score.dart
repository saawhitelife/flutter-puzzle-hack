...
/// {@template walkie_score}
/// Displays the score of the solved Walkie puzzle.
/// {@endtemplate}
class WalkieScore extends StatelessWidget {
  /// {@macro walkie_score}
  const WalkieScore({Key? key}) : super(key: key);
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(
                        key: const Key('walkie_score_completed'),
                        ...
                        child: AnimatedDefaultTextStyle(
                          ...
                          child: Text(l10n.walkieSuccessCompleted),
                        ),
                      ),
                      const ResponsiveGap(
                        small: 8,
                      ...
                      AnimatedDefaultTextStyle(
                        key: const Key('walkie_score_well_done'),
                        style: wellDoneTextStyle.copyWith(
                          color: PuzzleColors.white,
                        ),
                        duration: PuzzleThemeAnimationDuration.textStyle,
                        child: Text(l10n.walkieSuccessWellDone),
                      ),
                      const ResponsiveGap(
                        small: 24,
                        medium: 32,
                      ...
                      AnimatedDefaultTextStyle(
                        key: const Key('walkie_score_score'),
                        style: PuzzleTextStyle.headline5.copyWith(
                          color: theme.defaultColor,
                        ),
                        duration: PuzzleThemeAnimationDuration.textStyle,
                        child: Text(l10n.walkieSuccessScore),
                      ),
                      const ResponsiveGap(
                        small: 8,
                        medium: 9,
                      ...
                      AnimatedDefaultTextStyle(
                        key: const Key('walkie_score_number_of_moves'),
                        style: numberOfMovesTextStyle.copyWith(
                          color: PuzzleColors.white,
                        ),
                        duration: PuzzleThemeAnimationDuration.textStyle,
                        child: Text(
                          l10n.walkieSuccessNumberOfMoves(
