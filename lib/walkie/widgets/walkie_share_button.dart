...
/// {@template walkie_twitter_button}
/// Displays a button that shares the Flutter Puzzle challenge
/// on Twitter when tapped.
/// {@endtemplate}
class WalkieTwitterButton extends StatelessWidget {
  /// {@macro walkie_twitter_button}
  const WalkieTwitterButton({Key? key}) : super(key: key);

  String _twitterShareUrl(BuildContext context) {
    final shareText = context.l10n.walkieSuccessShareText;
...
/// {@template walkie_facebook_button}
/// Displays a button that shares the Flutter Puzzle challenge
/// on Facebook when tapped.
/// {@endtemplate}
class WalkieFacebookButton extends StatelessWidget {
  /// {@macro walkie_facebook_button}
  const WalkieFacebookButton({Key? key}) : super(key: key);
...
/// {@template walkie_share_button}
/// Displays a share button colored with [color] which
/// displays the [icon] and [title] as its content.
/// {@endtemplate}
@visibleForTesting
class WalkieShareButton extends StatefulWidget {
  /// {@macro walkie_share_button}
  const WalkieShareButton({
    Key? key,
  ...
  @override
  State<WalkieShareButton> createState() => _WalkieShareButtonState();
}

class _WalkieShareButtonState extends State<WalkieShareButton> {
